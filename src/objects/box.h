...
box<mat>::box(const point3 &p0, const point3 &p1, shared_ptr<mat> ptr) {
  ...
  sides.add(make_shared<flip_face<mat>>(make_shared<xy_rect<mat>>(p0.x(), p1.x(), p0.y(), p1.y(), p1.z(), ptr)));
  sides.add(make_shared<flip_face<mat>>(make_shared<xy_rect<mat>>(p0.x(), p1.x(), p0.y(), p1.y(), p0.z(), ptr)));
  ...
  sides.add(make_shared<flip_face<mat>>(make_shared<yz_rect<mat>>(p0.y(), p1.y(), p0.z(), p1.z(), p1.x(), ptr)));
  sides.add(make_shared<flip_face<mat>>(make_shared<yz_rect<mat>>(p0.y(), p1.y(), p0.z(), p1.z(), p0.x(), ptr)));
}
